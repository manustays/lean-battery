...
enum LoginItem {
	...
	static var statusText: String? {
		switch SMAppService.mainApp.status {
		case .requiresApproval: "Approve SlimBattery in System Settings → General → Login Items."
		case .enabled: nil
	...
	private static var fallbackURL: URL {
		FileManager.default.homeDirectoryForCurrentUser
			.appendingPathComponent("Library/LaunchAgents/\(Bundle.main.bundleIdentifier ?? "SlimBattery").plist")
	}
